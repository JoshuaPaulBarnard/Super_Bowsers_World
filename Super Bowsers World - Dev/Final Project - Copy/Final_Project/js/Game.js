...
BowsersWorld.Game.prototype = {
  ...
  create: function() {
      ...
      this.player.animations.add('breathFireLeft', [0], 10, true);
      this.player.animations.add('breathFireRight', [8], 10, true);
