...
BowsersWorld.Preload.prototype = {
  preload: function() {
    ...
    this.load.spritesheet('bowserSmall', 'assets/sprites/bowser_sprite_small.png', 32, 34);
    this.load.spritesheet('bowserLarge', 'assets/sprites/bowser_sprite_large.png', 32, 68);
    this.load.spritesheet('marioLarge', 'assets/sprites/mario_sprite.png', 21, 64);
    this.load.spritesheet('luigiLarge', 'assets/sprites/luigi_sprite.png', 19, 64);
